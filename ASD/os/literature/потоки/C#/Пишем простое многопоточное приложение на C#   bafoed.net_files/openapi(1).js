...
if (top && top != window && !document.referrer && location.toString().match(/\Wviewer_id=\d+(\W|$)/)) {
  VK._protocol = 'https:';
}
  ...
  VK.Widgets.Ads = function(objId, options, paramsExtra) {
    ...
    function adsCheckVisible(oneAdMaxWidth, oneAdMaxHeight) {
      ...
      if (iframe.getBoundingClientRect) {
        ...
        isVisibleAds       = (isVisibleAds && firstAdCenterY > 0 && firstAdCenterY < windowHeight);
    ...
    function adsInsertHtmlHandler(handlerHtml, width, height) {
      ...
      iframeHandler.id                = iframe.id + '_ads_html_handler';
